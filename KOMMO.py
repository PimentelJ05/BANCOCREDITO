...
def contar_leads_por_status(access_token, refresh_token, pipeline_id, status_id):
    ...
    while True:
        ...
        if response.status_code == 200:
            ...
            return None, f"Erro 204 - Nenhum dado encontrado para o funil {pipeline_id} e status {status_id}"
        else:
...
print("\nTabela de Leads:")
print(tabulate(leads_atual, headers='keys', tablefmt='grid'))


if erros:
    print("\nTabela de Erros:")
    print(tabulate(erros, headers='keys', tablefmt='grid'))
else:
